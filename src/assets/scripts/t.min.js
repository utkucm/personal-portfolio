  ...
  c.fn.t = function (p, B) {
    return this.each(function () {
      ...
      if (b.data().is_typing)
        return (
          l == 'paused'.slice(0, -1) &&
            (b.data('paused', e(a, 'b') ? (oo_ = a) : b.data('paused') ? (oo_ = !1) : (oo_ = !0)),
      ...
      if ('add' == l && b.data().t) {
        ...
        b.data().t ||
          (b.wrapInner(
            c('<' + a.tag + '/>', { class: 't-container', style: 'top:auto;bottom:auto;' })
          ),
        ...
        !0 === a.beep &&
          ...
          (c('html').data(
            '__TAC',
            (__TAC = (window.AudioContext = window.AudioContext || window.webkitAudioContext)
              ? new AudioContext()
              : !1)
          ),
          __TAC || (a.beep = !1));
        ...
        e(a.caret, 's') &&
          ...
          !e(a.blink) && (a.blink = !1),
          (t = c('<' + a.tag + '/>', { class: 't-caret', html: a.caret }).appendTo(b)),
          a.blink &&
            b.append('\u200b') &&
            b.data(
              'bi',
              setInterval(function () {
                (m.parent().data().blinking | (v = 'h' == t.css('visibility')[0]) ||
                  a.blink_perm) &&
              ...
              c('.t-container')
                ...
                .each(function () {
                  ...
                  c(this).p(
                    'h' == h
                      ? !0
                      : c(this).data().keep_paused && c(this).removeData('keep_paused')
                      ? !0
                      : !1
                  );
                });
      ...
      k = k
        ...
        .replace(/<del(.*?)>([\s\S]*?)<\/del>/g, function (a, b, c, d) {
          s =
            (s = c.match(/<s>\s*(.*?)\s*<\/s>/i)) && s[0] ? ' data-s="' + (s[1] || '1') + '"' : '';
          i = (i = c.match(/data-ins="(.*?)"/)) && i[1] ? i[1] : '' == s ? 0.25 : 0.75;
          c = c.replace(/(<s>.*?<\/s>|<[\/]?.*?>)/g, '');
          return (
            '<del' +
            b +
      ...
      var D = setInterval(function () {
        if (m.parent().data('paused')) u = 1;
          ...
          if (
            ...
            '*' == r &&
              (m.wrapInner(c('<' + a.tag + '/>', { class: 'typing-0', style: 'display:none;' })),
              (b = b.parent()),
              q &&
                ((k = c.merge(['<' + a.tag + ' class="typing-add"></' + a.tag + '>'], k, [
                  '</' + a.tag + '>',
                ])),
                (b = b.parent())));
            b = b.parent();
          ...
          (d = k.shift())
            ? (((a.mistype && !a.kbd) || (a.kbd && /kbd/i.test(b.prop('tagName')))) &&
                d &&
                !d[1] &&
                '\u200b' != b.data().del &&
                ' ' != d &&
